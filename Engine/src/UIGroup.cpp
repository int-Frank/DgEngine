...
//namespace Engine
//{
//  UIGroup::UIGroup(std::string const& a_name, 
//                   float a_x, float a_y, int a_depth,
//                   float a_scale_x, float a_scale_y,
//                   float a_rotation,
//                   float a_anchor_x, float a_anchor_y) //top left = [0, 0], bottom right = [1, 1]
//    : UIWidget(a_name, a_x, a_y, a_depth, a_scale_x, a_scale_y, a_rotation, a_anchor_x, a_anchor_y, false)
//    , m_pFocus(nullptr)
//  {
//
//  }
