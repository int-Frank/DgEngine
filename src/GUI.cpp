...
#define CLR_CONTAINER_SLIDER_BACK       CLR_SECONDARY_SEMIDARK
#define CLR_CONTAINER_SLIDER_CARET      CLR_PRIMARY
...
namespace DgE
{
  namespace GUI
  {
    ...
    Style::Window const Window::s_style =
    {
      ...
      BORDER_WIDTH,
      CLR_CONTAINER_SLIDER_BACK,
      CLR_CONTAINER_SLIDER_CARET,
    };
